...
public class CheckInTicketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkInTicketLabel.setText("Check in vé (ID: " + ticketReservation.getTicketReservationID() + ")");
        ...
        checkInTicketSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.equals("") || surname.equals("") || passportNumber.equals("") || nationality.equals("")){
                    Toast.makeText(CheckInTicketActivity.this, "Vui lòng nhập đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    Toast.makeText(CheckInTicketActivity.this, "Check in vé thành công!", Toast.LENGTH_SHORT).show();
