...
public class TicketA extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("UserTiket", user.toString());
        Log.d("UserTiket", String.valueOf(current_position_in_list));
    ...
    private void updateAllTicketReservationList() {
        ...
        Log.d("UserTiket", allCheckInTicket.get(0).getTicketReservationDepartureDateAndTime());
