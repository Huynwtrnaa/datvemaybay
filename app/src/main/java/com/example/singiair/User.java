...
public class User implements Serializable {
    ...
    public User(int id, String userName, String userSurname, String userEmail, String userPassword, String userUsername, String userPosition, boolean is_logged, double money) {
        _id = id;
        UserName = userName;
